...
export function registerUnloadFamilyTool(server) {
    server.tool("unload_family", "Unload a family from the current Revit project. The family types and instances are removed, but the family definition can be reloaded later.", {
