...
export function registerCreateHvacZoneTool(server) {
    server.tool("create_hvac_zone", "Create HVAC zones in Revit by grouping spaces into thermal/ventilation zones with defined boundaries", {
