...
export function registerMeasureDistanceTool(server) {
    server.tool("measure_distance", "Measure the distance between two points. Returns the distance in millimeters (mm).", {
