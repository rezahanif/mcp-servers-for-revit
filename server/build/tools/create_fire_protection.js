...
export function registerCreateFireProtectionTool(server) {
    server.tool("create_fire_protection", "Create fire protection piping systems in Revit (sprinkler pipes, standpipes). All coordinates in millimeters.", {
        data: z
            .array(z.object({
            startPoint: z.object({
