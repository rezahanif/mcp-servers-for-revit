...
export function registerCreateMaterialTool(server) {
    server.tool("create_material", "Create a standalone Revit Material with its own duplicated AppearanceAssetElement.", {
