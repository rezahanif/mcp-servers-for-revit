...
export function registerCreateElectricalPanelTool(server) {
    server.tool("create_electrical_panel", "Place electrical panelboards/distribution panels in Revit with specified configuration. All coordinates in millimeters.", {
        data: z
            .array(z.object({
            location: z.object({
