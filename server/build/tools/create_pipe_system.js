...
export function registerCreatePipeSystemTool(server) {
    server.tool("create_pipe_system", "Create piping systems in Revit by assigning pipes to plumbing/piping system types (Domestic Hot Water, Sanitary, etc.)", {
