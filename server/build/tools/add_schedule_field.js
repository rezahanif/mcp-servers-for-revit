...
export function registerAddScheduleFieldTool(server) {
    server.tool("add_schedule_field", "Add one or more fields to an existing Revit schedule. Fields are Revit built-in or shared parameter names.", {
