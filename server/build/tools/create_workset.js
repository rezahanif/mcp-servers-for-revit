...
export function registerCreateWorksetTool(server) {
    server.tool("create_workset", "Create a new workset in the Revit project. Worksets enable worksharing by allowing team members to partition the model into editable segments.", {
