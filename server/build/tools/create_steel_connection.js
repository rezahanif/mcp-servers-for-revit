...
export function registerCreateSteelConnectionTool(server) {
    server.tool("create_steel_connection", "Create steel connections between structural members (beam-column joints, splices) using Revit Steel API", {
        data: z
            .array(z.object({
