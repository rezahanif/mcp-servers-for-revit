...
export function registerExportSchedulesTool(server) {
    server.tool("export_schedules", "Export all (or selected) schedules from Revit to Excel or CSV. Produces a multi-sheet workbook or multi-file CSV output.", {
