...
export function registerCreateSharedParameterTool(server) {
    server.tool("create_shared_parameter", "Create a shared parameter definition in the project's shared parameter file. Shared parameters can be bound to multiple categories and used across projects.", {
