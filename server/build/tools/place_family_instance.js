...
export function registerPlaceFamilyInstanceTool(server) {
    server.tool("place_family_instance", "Place instances of a loaded family at specified locations. Supports host-based and free-standing families.", {
