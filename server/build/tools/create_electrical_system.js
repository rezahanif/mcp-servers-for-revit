...
export function registerCreateElectricalSystemTool(server) {
    server.tool("create_electrical_system", "Create electrical circuits/systems in Revit by assigning electrical equipment to circuits on a panel", {
