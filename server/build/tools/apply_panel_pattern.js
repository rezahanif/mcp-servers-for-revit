...
export function registerApplyPanelPatternTool(server) {
    server.tool("apply_panel_pattern", "Apply a panel arrangement pattern to a curtain wall. Requires a type mapping table and an arrangement matrix.", {
