...
export function registerCreateDetailComponentTypeTool(server) {
    server.tool("create_detail_component_type", "Duplicate a detail item family type and auto-fill sheet/detail number type parameters (detail number, sheet name, detail name, detail number), naming the new type '<sheetNumber>-<sheetName>-<detailName>'.", {
