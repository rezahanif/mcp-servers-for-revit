...
export function registerGetFamilyParametersTool(server) {
    server.tool("get_family_parameters", "List all parameters available for a family type, including built-in and shared parameters with their types and values.", {
