...
export function registerApplyViewTemplateTool(server) {
    server.tool("apply_view_template", "Apply a view template to one or more views. Transfers all display settings (visibility, graphics, scale, detail level) from the template to the target views.", {
