...
export function registerCreateFacadePanelTool(server) {
    server.tool("create_facade_panel", "Create a single facade panel (DirectShape). Supports 5 geometry types: curved_panel, beveled_opening, angled_panel, rounded_opening, flat_panel.", {
