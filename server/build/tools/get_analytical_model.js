...
export function registerGetAnalyticalModelTool(server) {
    server.tool("get_analytical_model", "Query the analytical model for structural elements, retrieving forces, reactions, and member properties", {
