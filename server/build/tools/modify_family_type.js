...
export function registerModifyFamilyTypeTool(server) {
    server.tool("modify_family_type", "Edit parameter values of an existing family type. Updates the type properties for all instances of that type.", {
