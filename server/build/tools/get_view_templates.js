...
export function registerGetViewTemplatesTool(server) {
    server.tool("get_view_templates", "List all view templates in the Revit project. Returns template names, IDs, view types, and which views have each template applied.", {
