...
export function registerCreateWireTool(server) {
    server.tool("create_wire", "Draw wire connections between electrical equipment or connectors in Revit. All coordinates in millimeters.", {
        data: z
            .array(z.object({
            points: z
                .array(z.object({
