...
export function registerGetMepElementsTool(server) {
    server.tool("get_mep_elements", "Query MEP elements (ducts, pipes, electrical, plumbing) filtered by system type, category, or level", {
