...
export function registerConnectMepToSpaceTool(server) {
    server.tool("connect_mep_to_space", "Connect MEP elements to room/space elements for volume and load calculations", {
        data: z
            .array(z.object({
