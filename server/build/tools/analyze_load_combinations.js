...
export function registerAnalyzeLoadCombinationsTool(server) {
    server.tool("analyze_load_combinations", "Analyze and retrieve load combinations defined in the Revit structural model", {
