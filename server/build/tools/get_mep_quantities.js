...
export function registerGetMepQuantitiesTool(server) {
    server.tool("get_mep_quantities", "Extract MEP material quantities and takeoffs (duct lengths, pipe runs, fittings counts, insulation areas)", {
