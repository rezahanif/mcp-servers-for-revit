...
export function registerExportNavisworksTool(server) {
    server.tool("export_navisworks", "Export the Revit model to a Navisworks coordination file (.nwc) with preserved element IDs, linked CAD conversions, and shared coordinates for 4D/5D clash detection.", {
