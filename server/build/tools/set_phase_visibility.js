...
export function registerSetPhaseVisibilityTool(server) {
    server.tool("set_phase_visibility", "Control phase visibility in views. Apply a phase filter to a view or set phase display options (show new, show existing, show demolished, etc.).", {
