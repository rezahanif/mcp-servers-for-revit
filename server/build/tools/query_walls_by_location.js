...
export function registerQueryWallsByLocationTool(server) {
    server.tool("query_walls_by_location", "Query walls near a coordinate (spatial proximity search, not an attribute filter). Returns thickness, location-line coordinates, and both wall faces for each nearby wall.", {
