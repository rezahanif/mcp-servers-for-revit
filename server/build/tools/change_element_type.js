...
export function registerChangeElementTypeTool(server) {
    server.tool("change_element_type", "Change a Revit element's (or a batch of elements') type — e.g. switch a wall from Type A to Type B. Elements that cannot have a type assigned are reported per-element rather than failing the whole batch.", {
