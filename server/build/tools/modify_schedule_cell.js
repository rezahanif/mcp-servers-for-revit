...
export function registerModifyScheduleCellTool(server) {
    server.tool("modify_schedule_cell", "Edit cell values in a Revit schedule. Modify text/numeric values for specific cells identified by row and column.", {
