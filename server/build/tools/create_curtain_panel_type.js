...
export function registerCreateCurtainPanelTypeTool(server) {
    server.tool("create_curtain_panel_type", "Create a new curtain wall panel type, with an optional color (hex) and transparency.", {
