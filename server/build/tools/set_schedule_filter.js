...
export function registerSetScheduleFilterTool(server) {
    server.tool("set_schedule_filter", "Apply or update filters on a Revit schedule. Filters restrict which rows are displayed based on field values.", {
