...
export function registerLoadSharedParametersTool(server) {
    server.tool("load_shared_parameters", "Load a shared parameter file and bind the specified parameters to the given categories, at Type or Instance level. Use before writing custom parameter values, to make sure the project has the parameter definitions loaded. 'Columns' binds both OST_Columns and OST_StructuralColumns. dryRun=true reports what would be bound/expanded/skipped without changing the document.", {
