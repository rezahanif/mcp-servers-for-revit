...
export function registerGetPhaseFilterTool(server) {
    server.tool("get_phase_filter", "Get phase filter settings for a view. Returns which phases are visible, their display style (show new, show existing, show demolished, etc.).", {
