...
export function registerDeleteViewTemplateTool(server: McpServer) {
  server.tool(
    "delete_view_template",
    "Delete one or more view templates from the Revit project. Views that had the template applied will retain their current settings.",
    {
