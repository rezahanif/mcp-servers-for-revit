...
export function registerSetStructuralMaterialTool(server: McpServer) {
  server.tool(
    "set_structural_material",
    "Assign or change structural materials on structural elements (concrete, steel, wood, etc.)",
    {
      data: z
        .array(
          z.object({
