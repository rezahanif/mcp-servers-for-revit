...
export function registerBindParameterTool(server: McpServer) {
  server.tool(
    "bind_parameter",
    "Bind a shared or project parameter to one or more categories. Controls which element categories display the parameter.",
    {
