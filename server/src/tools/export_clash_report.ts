...
export function registerExportClashReportTool(server: McpServer) {
  server.tool(
    "export_clash_report",
    "Export the result of check_clashes as a report file. format is csv, json, or both. Defaults to the user's Desktop with a timestamped filename when outputPath is omitted.",
    {
      clashData: z
        .object({})
        .passthrough()
