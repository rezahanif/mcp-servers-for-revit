...
export function registerGetCircuitLoadTool(server: McpServer) {
  server.tool(
    "get_circuit_load",
    "Calculate and retrieve electrical circuit load information from panels and circuits in Revit",
    {
