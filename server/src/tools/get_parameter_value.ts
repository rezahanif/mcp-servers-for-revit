...
export function registerGetParameterValueTool(server: McpServer) {
  server.tool(
    "get_parameter_value",
    "Read parameter values from one or more Revit elements. Returns parameter names, values, storage types, and units.",
    {
