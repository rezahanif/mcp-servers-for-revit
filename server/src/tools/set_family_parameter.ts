...
export function registerSetFamilyParameterTool(server: McpServer) {
  server.tool(
    "set_family_parameter",
    "Set parameter values on a family instance or family type. Works with both instance and type parameters.",
    {
