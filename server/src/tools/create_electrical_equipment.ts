...
export function registerCreateElectricalEquipmentTool(server: McpServer) {
  server.tool(
    "create_electrical_equipment",
    "Place electrical equipment families in Revit (e.g., panels, transformers, switchgear). All coordinates in millimeters.",
    {
      data: z
        .array(
          z.object({
