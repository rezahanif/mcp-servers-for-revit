...
export function registerCreatePhaseTool(server: McpServer) {
  server.tool(
    "create_phase",
    "Create a new project phase in Revit. Phases represent construction stages (e.g., Existing, New Construction, Demolished).",
    {
