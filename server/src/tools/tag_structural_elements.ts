...
export function registerTagStructuralElementsTool(server: McpServer) {
  server.tool(
    "tag_structural_elements",
    "Tag structural elements in a view with member type, size, or other parameters using IndependentTag",
    {
