...
export function registerExportDfxTool(server: McpServer) {
  server.tool(
    "export_dfx",
    "Export a Revit view or sheet to DXF format. Similar to DWG export but uses the DXF interchange format.",
    {
