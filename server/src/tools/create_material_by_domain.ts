...
export function registerCreateMaterialByDomainTool(server: McpServer) {
  server.tool(
    "create_material_by_domain",
    "Create a pure standalone Material (no prefixing, no default-wall base) with a fixed neutral color.",
    {
