...
export function registerCreateDuctSystemTool(server: McpServer) {
  server.tool(
    "create_duct_system",
    "Create HVAC duct systems in Revit by assigning ducts to mechanical system types (Supply Air, Return Air, Exhaust Air, etc.)",
    {
