...
export function registerCreateGreenMaterialTool(server: McpServer) {
  server.tool(
    "create_green_material",
    "Create a standalone Revit Material with a specified RGB color (used for green building assessment or visual verification).",
    {
