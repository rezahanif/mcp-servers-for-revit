...
export function registerCheckClashesTool(server: McpServer) {
  server.tool(
    "check_clashes",
    "Perform geometric interference and clash detection between elements or categories (e.g., Walls vs Walls, MEP vs Structure). Returns colliding pairs with element IDs, clash types, and resolution advice.",
    {
