...
export function registerCreateViewTemplateTool(server: McpServer) {
  server.tool(
    ...
    "Create a new view template from an existing view in Revit. View templates capture display settings (visibility, graphics, scale, detail level) that can be applied to other views.",
    {
