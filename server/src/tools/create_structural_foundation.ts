...
export function registerCreateStructuralFoundationTool(server: McpServer) {
  server.tool(
    "create_structural_foundation",
    "Place structural foundations (isolated, strip, or wall foundations) in Revit. All coordinates in millimeters.",
    {
      data: z
        .array(
          z.object({
