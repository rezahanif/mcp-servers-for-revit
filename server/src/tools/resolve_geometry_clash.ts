...
export function registerResolveGeometryClashTool(server: McpServer) {
  server.tool(
    "resolve_geometry_clash",
    "Resolve geometric overlap and collision between two elements using Revit's Cut Geometry or Join Geometry APIs. Resolves warnings like 'Highlighted walls overlap. Use Cut Geometry to embed one wall within the other.'",
    {
