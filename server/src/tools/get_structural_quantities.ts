...
export function registerGetStructuralQuantitiesTool(server: McpServer) {
  server.tool(
    "get_structural_quantities",
    "Extract structural member quantities (lengths, volumes, weights, material takeoffs) for structural elements",
    {
