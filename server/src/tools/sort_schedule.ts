...
export function registerSortScheduleTool(server: McpServer) {
  server.tool(
    "sort_schedule",
    "Set sort and grouping criteria for a Revit schedule. Controls row ordering and grouping/blank lines.",
    {
