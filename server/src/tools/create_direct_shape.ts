...
export function registerCreateDirectShapeTool(server: McpServer) {
  server.tool(
    "create_direct_shape",
    "Create custom 3D solid geometry in Revit using DirectShape (ideal for civil engineering: retaining walls, bridge piers, abutments, box culverts, terrain blocks). Supports box solids and polygon-profile extrusions.",
    {
