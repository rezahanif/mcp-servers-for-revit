...
export function registerExportMepSchedulesTool(server: McpServer) {
  server.tool(
    "export_mep_schedules",
    "Export MEP data to Revit schedules (duct, pipe, equipment counts and quantities)",
    {
