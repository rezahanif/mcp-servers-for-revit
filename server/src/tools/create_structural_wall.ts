...
export function registerCreateStructuralWallTool(server: McpServer) {
  server.tool(
    "create_structural_wall",
    "Create structural walls in Revit with specified type, level, and constraints. All coordinates in millimeters.",
    {
      data: z
        .array(
          z.object({
