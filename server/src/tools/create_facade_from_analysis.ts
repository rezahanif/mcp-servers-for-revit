...
export function registerCreateFacadeFromAnalysisTool(server: McpServer) {
  server.tool(
    "create_facade_from_analysis",
    "Batch-create a full facade based on an analysis result. Creates multiple DirectShape panels in front of a wall, supporting multiple panel types and arrangement patterns.",
    {
