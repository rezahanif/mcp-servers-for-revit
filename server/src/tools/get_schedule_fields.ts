...
export function registerGetScheduleFieldsTool(server: McpServer) {
  server.tool(
    "get_schedule_fields",
    "List all fields in an existing Revit schedule. Returns field names, types, and visibility settings.",
    {
