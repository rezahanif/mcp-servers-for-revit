...
export function registerExportDwgTool(server: McpServer) {
  server.tool(
    "export_dwg",
    "Export a Revit view, sheet, or model to DWG format. Supports configurable export options including layers, linetypes, and units.",
    {
