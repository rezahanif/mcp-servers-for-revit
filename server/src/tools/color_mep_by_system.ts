...
export function registerColorMepBySystemTool(server: McpServer) {
  server.tool(
    "color_mep_by_system",
    "Color MEP elements by system type using OverrideGraphicsSettings for visual differentiation",
    {
