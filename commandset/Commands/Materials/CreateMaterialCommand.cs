...
{
    /// <summary>Create a standalone Material with its own AppearanceAssetElement.</summary>
    public class CreateMaterialCommand : ExternalEventCommandBase
    {
        ...
        public CreateMaterialCommand(UIApplication uiApp) : base(new CreateMaterialEventHandler(), uiApp) { }
        ...
        public override object Execute(JObject parameters, string requestId)
        {
            ...
            throw new System.TimeoutException("create_material timed out");
        }
    }
}
